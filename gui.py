...
def show_welcome_window():
    ...
    record_button = tk.Button(welcome_frame, text="Record", command=lambda: fade_out(welcome_window, create_record_screen), width=15, height=2, font=("Helvetica", 24), bg="#4B0082", fg="white")
